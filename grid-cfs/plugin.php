...
return array(
    ...
    'config' => array(
        ...
        'label' => 'Grid CFS',
        'core'  => true,
        'icon'  => 'plugins/widgets/grid-cfs/widget.svg',
        'view'  => 'plugins/widgets/grid-cfs/views/widget.php',
    ...
    'events' => array(
        ...
        'init.admin' => function($event, $app) {
            $app['angular']->addTemplate('grid-cfs.edit', 'plugins/widgets/grid-cfs/views/edit.php', true);
        }
